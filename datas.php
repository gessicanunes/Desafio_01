...
$teste = "Variaveis estãp recebendo alguma coisa";
...
$cont = 0;
do {
	$anoInicial = substr($dataInicial, -10, 4); // seleciona somento o ano da data inicial
	$anoFinal = substr($dataFinal, -10, 4);  // selecionan somente d ano da data final
   
	if($anoInicial != $anoFinal){ $cont = ++$cont; } 

   } while ($anoFinal != $cont); 

echo $cont, $anoFinal, $anoInicial;
